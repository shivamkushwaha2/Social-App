...
import com.InSoft.social.messages.ChatLogActivity
import com.InSoft.social.models.Users
import com.InSoft.social.views.BigImageDialog
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                dataSnapshot.children.forEach {
                    ...
                    it.getValue(Users::class.java)?.let {
...
class UserItem(val user: Users, val context: Context) : Item<GroupieViewHolder>() {
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        if (!user.profileImageUrl!!.isEmpty()) {
            ...
            Glide.with(viewHolder.itemView.imageview_new_message.context)
                    ...
                    .into(viewHolder.itemView.imageview_new_message as ImageView)
